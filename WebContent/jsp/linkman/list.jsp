	...
	$(function(){
		...
		$.post(url, function(data){
			$(data).each(function(){
				...
				if(id == this.cust_id){
					$("#selectId1").append("<option value='"+this.cust_id+"' selected>"+this.cust_name+"</option>");
				}else{
					$("#selectId1").append("<option value='"+this.cust_id+"'>"+this.cust_name+"</option>");
				}
			});
		}, "json");
	});
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>客户名称：</TD>
													<TD>
														<select name="customer.cust_id" id="selectId1">
